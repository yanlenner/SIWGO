...
<html lang="es">
  ...
  <body>
    ...
    <br><br>
    <div class="row">
      <form class="col s12 del_usr" method="post" action="delete" target="_top">
        <fieldset class="campo-morado">
          <a data-target="slide-out" class="sidenav-trigger">
            <h5 class="blanco"><img class="tooltipped menui" src="../../../src/img/menusu.png" data-position="bottom" data-tooltip="Muestra el menú lateral izquierdo"> Eliminar usuario</h5>
          </a>
          <div class="row">
            <div class="input-field col s6">
              <input id="search" type="text" class="validate identificacion blanco" name="search" autocomplete="off" required="">
              <label for="search">Número de cédula</label>
            </div>
            <div class="input-field col s6">
              <input id="usuario" type="text" class="validate blanco" name="usr" maxlength="10" autocomplete="off" required="" readonly="">
          ...
          <div class="row">
            ...
            <div class="input-field col s6">
              <input id="date" type="text" class="validate datepicker blanco" name="fecha" onkeyup="this.value=NoEscribir(this.value)" autocomplete="off" required="">
              <label for="date">Fecha de nacimiento</label>
            </div>
          </div>
        </fieldset>
        <input id="del_usr" class="btn-azul in-right tooltipped" type="button" value="Eliminar" data-position="left" data-tooltip="Elimina el usuario por completo">
    ...
    <script  src="../../../src/js/usr.js"></script>

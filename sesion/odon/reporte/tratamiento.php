...
<html lang="es">
  ...
  <body>
    ...
    <br><br>
    <div class="row">
      <form class="col s12" method="post" action="tr4t">
        <fieldset class="campo-morado">
          <a data-target="slide-out" class="sidenav-trigger">
            <h5 class="blanco"><img class="tooltipped menui" src="../../../src/img/menurep.png" data-position="bottom" data-tooltip="Muestra el menú lateral izquierdo"> Datos para el Tratamiento</h5>
          </a>
          <div class="row">
            ...
            <div class="input-field col s6">
              <input id="dura" type="text" class="validate blanco" name="dura" autocomplete="off" maxlength="15" required="">
              <label for="dura"> Duración del tratamiento</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s6">
            ...
            <div class="input-field col s6">
              <input id="consulta" type="text" class="validate blanco" name="consulta" autocomplete="off" maxlength="10">
              <label for="consulta"> No de consulta que lo justifica</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <textarea id="reci" class="materialize-textarea blanco" autocomplete='off' rows='2' name='reci' maxlength='100' onkeyup="this.value=Dir(this.value);" required=""></textarea>
              <label for="reci">Médicamentos</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <textarea id="indi" class="materialize-textarea blanco" autocomplete='off' rows='2' name='indi' maxlength='250' onkeyup="this.value=Dir(this.value);" required=""></textarea>
              <label for="indi">Indicaciones</label>
            </div>
          </div>
        </fieldset>
        <input class="btn-azul in-right tooltipped" type="submit" disabled value="Emitir Tratamiento" data-position="left" data-tooltip="En formato de impresión">
        <input class="btn-azul in-left tooltipped" type="button" onclick="atend(); buscar(); verificar(); mostrarc();"  value="Buscar" data-position="bottom" data-tooltip="Comprueba sí el paciente ya esta registrado y también si ha sido atendido">
    ...
    <script  src="../../../src/js/tratados.js"></script>
  </body>
</html>
<?php
}

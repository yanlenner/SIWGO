...
<html lang="es">
  ...
  <body>
    ...
    if(empty($_POST['ci']))
    die("<h2 style='text-align: center; margin-top: 12%;'> Para realizar este proceso se requiere que el odontólogo escriba el informe del paciente </h2><h4><a href='./' style='color:#66328f;text-decoration: none;'>Volver</a></h4>");
    $cedula = $_POST['ci'];
    ...
    echo "<h2 style='text-align: center; margin-top: 12%;'> Les has registrado el informe a $nombre</h2><br><h4><a href='./' style='color:#66328f'>Continuar</a></h4>";
    else
    echo "<h2 style='text-align: center; margin-top: 12%;'> No se pudo registrar el informe </h2><br><h4><a href='registrar_informe' style='color:#6f42c1'>Volver</a></h4>";
    mysqli_close($enlace);
    ?>
  </body>
</html>

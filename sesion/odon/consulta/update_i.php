...
<html lang="es">
  ...
  <body>
    ...
    if(empty($_POST['ci']))
    die("<h2 style='text-align: center; margin-top: 12%;'> Para realizar este proceso se requiere que el odontólogo actualice el informe del paciente  </h2><h4><a href='./' style='color:#66328f;text-decoration: none;'>Volver</a></h4>");
    $cedula = $_POST['ci'];

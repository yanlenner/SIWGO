...
<html lang="es">
  ...
  <body>
    ...
    <br><br>
    <div class="row">
      <form id="formulario" class="col s12" method="post" action="create_i">
        <!--Progressbar-->
        <ul class='progress'>
        ...
        <fieldset class="campo-morado" style="display: none;">
          <h5 class="blanco">Redacción del Informe</h5>
          ...
          <input id="ri" disabled="disabled" class="btn-azul in-right siguiente tooltipped" type="submit" value="Registrar Informe" data-position="left" data-tooltip="Registra los datos escritos">
    ...
    <script src="../../../src/js/pac2.js"></script>
  </body>
</html>
<?php
}

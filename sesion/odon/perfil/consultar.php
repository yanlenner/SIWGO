...
<html lang="es">
  ...
  <body>
    ...
    <br><br>
    <div class="row">
      <form class="col s12" method="post" action="paciente">
        <fieldset class="campo-morado">
          <a data-target="slide-out" class="sidenav-trigger">
            <h5 class="blanco"><img class="tooltipped menui" src="../../../src/img/menuper.png" data-position="bottom" data-tooltip="Muestra el menú lateral izquierdo"> Consultar Perfil del Paciente</h5>
          </a>
          <div class="row">
        ...
        <input class="btn-azul in-right tooltipped" type="submit" disabled value="Consultar" data-position="left" data-tooltip="Muestra el perfil del paciente">

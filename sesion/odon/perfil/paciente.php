...
<html lang="es">
    ...
    <body>
        ...
        if(empty($_POST['ci']))
        die("<h2 style='text-align: center; margin-top: 12%;'> No podemos mostrar los datos del estudiante sin el permiso del Odontólogo</h2><h4 class='center'><a href='./' style='color:#66328f;text-decoration: none;'>Volver</a></h4>");
        $ci=$_POST['ci'];
        //Conexión a la BD
        include '../../../src/php/enlace.php';

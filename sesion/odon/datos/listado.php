			...
			<form class="col s12" method="post" action="upload" enctype="multipart/form-data">
				<fieldset class="campo-morado">
					<a data-target="slide-out" class="sidenav-trigger">
						<h5 class="blanco"><img class="tooltipped menui" src="../../../src/img/menudat.png" data-position="bottom" data-tooltip="Muestra el menú lateral izquierdo"> Actualizar listado de estudiantes regulares</h5>
					</a>
					<div class="row">
					...
					<div class="row">
						<div class="input-field col s12">
							<input type="file" name="csv" required="" style="color:white;" class="tooltipped" data-position="right" data-tooltip="Adjunta un archivo csv">
						</div>
					</div>
				</fieldset>
				<input name="restore" class="btn-azul in-right tooltipped" type="submit" value="Cargar listado" data-position="left" data-tooltip="Carga un nuevo listado para reemplazar el anterior">
			</form>
		</div>

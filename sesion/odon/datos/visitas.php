	...
	<body>
			...
			<table id="my-example" class="display text-center" data-order='[[ 0, "asc" ]]' data-page-length='6'>
				<thead>
					<tr>
						...
						<th>Enlace</th>
						<th data-class-name="priority">Momento</th>
					</tr>
				</thead>
			</table>
		</div>
		<script type="text/javascript">
			...
			$(document).ready(function() {
				var usuario = window.opener.sesion;
				$('#titulo').html('SIWGO - Listado '+usuario+' de visitas por sesión');
				$('#my-example').dataTable({
					"bProcessing": true,
					"sAjaxSource": "../../../src/php/fin_consultastra.php",

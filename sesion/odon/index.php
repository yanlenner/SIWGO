...
<html lang="es">
    <head>
        ...
        <title>Menú Pral. del Odontólogo</title>
        <style type="text/css">
            #return-to-top{
                           background-image: linear-gradient(to bottom,#1a237e,#283593,#303f9f,#3949ab) !important;
                       }
        </style>
    </head>
    <body>
        <header align="center"><img src="../../src/img/banner.png">
            <h1>Sistema de Información Web para la Gestión de Pacientes del Servicio Odontológico "Kléber Ramírez"</h1>
        </header>
        <a href="javascript:" id="return-to-top"><i class="fa fa-lg fa-chevron-up" title="Subir"></i></a>
        <iframe style="margin-top: 5%; border: none; width:100%; height:30vh" src="lineal">
        </iframe>
        <iframe style="border: none; width:100%; height:110vh" src="iconic">
        </iframe>
        <footer>Programa Nacional de Formación en Informática &copy; 2019
        </footer>

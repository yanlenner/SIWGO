...
<html lang="es">
  ...
  <body>
    ...
    <br><br>
    <div class="row">
      <form class="col s12" method="post" action="h1st">
        <fieldset class="campo-morado">
          <a data-target="slide-out" class="sidenav-trigger">
            <h5 class="blanco"><img class="tooltipped menui" src="../../../src/img/menurep.png" data-position="bottom" data-tooltip="Muestra el menú lateral izquierdo"> Identificación del Paciente</h5>
          </a>
          <div class="row">
        ...
        <input class="btn-azul in-right tooltipped" type="submit" disabled value="Emitir Historia" data-position="left" data-tooltip="En formato de impresión">

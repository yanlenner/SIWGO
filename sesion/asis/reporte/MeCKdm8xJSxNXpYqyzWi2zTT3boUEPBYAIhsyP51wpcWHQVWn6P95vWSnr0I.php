...
<html lang="es">
	<head>
		<title>SIWGO - Reporte por edad de los antecedentes médicos</title>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				$('#my-example').dataTable({
					...
					fixedColumns: true,
					"bProcessing": true,
					"sAjaxSource": "../../../src/php/fin_antecedentedad.php",
					"aoColumns": [
					{ mData: 'nombre_antecedente' } ,
					{ mData: 'jovenes' },
					{ mData: 'adultos' },
					{ mData: 'mayores' },
					{ mData: 'total' }

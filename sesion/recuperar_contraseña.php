...
<html lang="es">
  ...
  <body>
    ...
    ?>
    <header>
      <a href="../"><img src="../src/img/banner.png"></a>
    ...
    <iframe class="embed-responsive" style="margin-top: 5%; border: none; width:100%; height:599px;" src="recuperar">
    </iframe>
    <footer>
      <a id="pie" href="../">Programa Nacional de Formación en Informática &copy; 2019</a>
      </footer>      <script src="../src/js/jquery-3.js"></script>
